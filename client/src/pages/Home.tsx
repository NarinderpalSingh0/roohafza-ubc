  ...
  return (
    <div className="rooh-site">
      <header className="rooh-nav">
        <a className="rooh-logo" href="#top" aria-label="Roohafza home"><img src={BRAND_ASSETS.wordmark} alt="Roohafza" /></a>
      ...
      <main id="top">
        ...
        <section className="rooh-hero section-pad" aria-labelledby="hero-title">
          ...
          <div className="rooh-hero-product" onPointerMove={(event) => {
            ...
            <img src={BRAND_ASSETS.berryBust} alt="Roohafza Berry Bust can" style={{ transform: `translate3d(${heroShift.x}px, ${heroShift.y}px, 0) rotate(${heroShift.x * .18}deg)` }} />
        ...
        <section className="story-section section-pad" id="story" aria-labelledby="story-title">
          <div className="story-poster"><div className="story-circle" /><img src={BRAND_ASSETS.straberry} alt="Roohafza Straberry can" /><span>Too cool<br />to rush.</span></div>
        ...
        <section className="newsletter-section section-pad" id="newsletter" aria-labelledby="newsletter-title">
          <div className="newsletter-art"><div className="newsletter-flower">✦</div><div className="newsletter-can"><img src={BRAND_ASSETS.rose} alt="Roohafza Rose can" /></div></div>
      ...
      <footer className="rooh-footer"><div className="footer-brandline"><a href="#top"><img src={BRAND_ASSETS.wordmark} alt="Roohafza" /></a><p>For every mood in between.</p><div className="footer-actions"><a href="https://www.instagram.com/roohfza_?utm_source=ig_web_button_share_sheet" target="_blank" rel="noreferrer"><Instagram size={16} />Instagram</a><button onClick={() => scrollToId("top")}>Back to top <ArrowUpRight size={16} /></button></div></div><div className="footer-bottom"><span>© 2026 Roohafza</span><span>Made for bright breaks</span><span>India · English</span></div></footer>
    </div>
  );
}
